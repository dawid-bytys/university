...
int main() {
  ...
  std::array<int, CONTAINER_SIZE> merge_abstract_array = {12, 64, 24, 19, 39,
                                                          33, 75, 70, 84, 51};
  std::vector<int> merge_vector = {12, 64, 24, 19, 39, 33, 75, 70, 84, 51};
  int merge_array[CONTAINER_SIZE] = {12, 64, 24, 19, 39, 33, 75, 70, 84, 51};

  test_sorting_algorithm(merge_abstract_array,
                         mergesort<std::array<int, CONTAINER_SIZE>::iterator>);
  test_sorting_algorithm(merge_vector, mergesort<std::vector<int>::iterator>);
  test_sorting_algorithm(merge_array, mergesort<int*>);
